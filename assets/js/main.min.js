$('.type-search .convenios').click(function(){
	var id= $(this).attr('id');
	$('.type-search .convenios').removeClass('active');
	$(this).addClass('active');
	$('.cont-answer').removeClass('active');
	$('#'+id+'-answer').addClass('active');
...
var funcionamientos = ( function( window, undefined ) {
  ...
  var componentMenuM1 = [
  	...
  	var mobileComponentsSelectorPop = [
  		...
  		{ selector : '.component-c75', active : '.cont-btn', 'showFirst' : false, innerContent: true},
...
$(function() {
	...
	/*Menú secciones responsive GQ*/
	function zindex(){
		
      $('.glyphicon.glyphicon-menu-hamburger.menu-mobile-button').click(function() {

          $(".right-buttons").attr("style","z-index:0","important"); 
        
      });
       $('.glyphicon.glyphicon-remove.like-anchor.menu-mobile-button').click(function() {

         $(".right-buttons").removeAttr("style"); 
	...
	function m4(){
		$(".cont-button.hidden-xs.hidden-md.hidden-lg.hidden-sm.visible-xs-block.active").removeClass("hidden-xs");
       	$(".cont-button.hidden-xs.hidden-md.hidden-lg.hidden-sm.visible-xs-block").removeClass("hidden-xs");
	}

	function createSections(){
		if($(".component-m2").length){
			$("#layout-column_column-1").prepend(
				"<section class='block-uvm' id='seccion-0'></section>" +
				"<section class='block-uvm' id='seccion-1'></section>" +
				"<section class='block-uvm' id='seccion-2'></section>" +
				"<section class='block-uvm' id='seccion-3'></section>" +
				"<section class='block-uvm' id='seccion-4'></section>" +
				"<section class='block-uvm' id='seccion-5'></section>"
			);
			if($(".component-m2.five-secc").length){
				$("#layout-column_column-1").append(
					"<section class='block-uvm' id='seccion-6'></section>"
				);
			}
			if($(".component-m2.six-secc").length){
				$("#layout-column_column-1").append(
					"<section class='block-uvm' id='seccion-6'></section>" +
					"<section class='block-uvm' id='seccion-7'></section>"
				);
			}
			if($(".component-m2.seven-secc").length){
				$("#layout-column_column-1").append(
					"<section class='block-uvm' id='seccion-6'></section>" +
					"<section class='block-uvm' id='seccion-7'></section>" +
					"<section class='block-uvm' id='seccion-8'></section>"
				);
			}
			$("section[id^='seccion-']").each(function(index){
				orderInSection(index,$("div[class*='component-container-seccion-"+ index +"']").parents(".portlet-boundary"));
			});
		}
	}
	function orderInSection(secNum, elements){
		$(elements).each(function(){
			$("#seccion-" + secNum).prepend($(this));
		});
	}
